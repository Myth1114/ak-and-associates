    ...
    <section className="home-about">
      <div className="container-wide home-about__inner">
        <div className="home-about__left">
          <p className="home-about__eyebrow eyebrow">About AK and Associates</p>
        ...
        <div className="home-about__right">
          <p className="home-about__lead body-text--strong">
          ...
          <p className="home-about__description body-text">
